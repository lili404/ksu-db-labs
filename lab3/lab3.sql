...
# SELECT CONCAT(UPPER(SUBSTRING(title, 1, 10)), '...', UPPER(SUBSTRING(title, CHAR_LENGTH(title) - 9))) AS '10...10' FROM library_storage;
...
# SELECT id, price, ROUND(price * 39.16) FROM library_storage;
# 16. Додати інформацію про нову книгу (всі колонки):
# INSERT INTO library_storage (n, id, novelty, title, price, publisher, pages, format, date, circulation, topic, category) VALUES(1, 1212, 'Yes', 'Book 1', 9.99, 'Company 1', 99, '70х100/16', '2017-01-01', 1000, 'Topic Placeholder', 'Category Placeholder');
# 17. Додати інформацію про нову книгу (колонки обов'язкові для введення)
# INSERT INTO library_storage (n, id, novelty, title, price, publisher, pages, format, date, circulation, topic, category) VALUES (3, 1213, '' ,'Book 2', 9.99, '', NULL, '', NULL, NULL, '', '' );
